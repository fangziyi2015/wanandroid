class NavigatorEntity {
  List<NaviArticleData>? data;
  int? errorCode;
  String? errorMsg;

  NavigatorEntity({this.data, this.errorCode, this.errorMsg});

  NavigatorEntity.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <NaviArticleData>[];
      json['data'].forEach((v) {
        data!.add(new NaviArticleData.fromJson(v));
      });
    }
...
class NaviArticleData {
  List<Articles>? articles;
  int? cid;
  String? name;

  NaviArticleData({this.articles, this.cid, this.name});

  NaviArticleData.fromJson(Map<String, dynamic> json) {
