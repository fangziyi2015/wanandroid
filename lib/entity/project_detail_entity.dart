class ProjectDetailEntity {
  ...
  ProjectDetailEntity({this.data, this.errorCode, this.errorMsg});

  ProjectDetailEntity.fromJson(Map<String, dynamic> json) {
...
class ProjectDetailData {
  ...
  ProjectDetailData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = <ProjectItemData>[];
      json['datas'].forEach((v) {
        datas!.add(new ProjectItemData.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class ProjectItemData {
  ...
  ProjectItemData.fromJson(Map<String, dynamic> json) {
